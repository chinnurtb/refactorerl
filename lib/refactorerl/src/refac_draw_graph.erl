...
%% @doc  Draws the whole graph to the file with edge filtering.
...
lexical_link(_, Tag) ->
    lists:member(
      Tag,
      [incl, macro, marg, mbody, mref, iref, next, lfirst, llast, llex,      
       ffirst, flast, flex, cfirst, clast, clex, efirst, elast, elex]).
