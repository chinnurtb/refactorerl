Nonterminals 
predicates predicate list element elements te1 te2 te3 tuples telements funlist tuple.

Terminals '(' ')' ',' '{' '}'
atom show for compare save module integer string function func fil.
